...
function UserDivisionMapping() {
  ...
  return (
    ...
    <Card
            ...
            >
              <p className='pg-label m-0'>User Division Mapping Master</p>
              <hr />


              <Row className='mb-2'><Col><Button variant='' className='add-Btn' onClick={handleShow}>Add New User Division Mapping</Button></Col></Row>
...
<Modal.Title className='mdl-title'>Add New User Division Mapping</Modal.Title>
</Modal.Header>
<Modal.Body>
...
export default UserDivisionMapping