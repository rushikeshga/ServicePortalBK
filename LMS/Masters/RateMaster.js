...
function RateMaster() {
    ...
    const fetchDataPagination = async (pageInfo) => {
        ...
        const url = new URL(
            ...
            `${process.env.REACT_APP_API_URL}ClaimRate/GetAllClaimRate`,
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "serviceClaimTypeName",
        ...
        <>
            ...
            >
                <div className='d-flex justify-content-between'>
                    ...
                    <p className='pg-label m-0'>Rate Master</p>

                    {Permissions?.isAdd ? <Row><Col><Button variant='' className='add-Btn' onClick={handleShow}>Add New Rate Master</Button></Col></Row> : ""}
                </div>
                <hr />
  ...
  <Col md={4} sm={4} xs={4}> */}
                ...
                <Modal show={show} onHide={handleClose} backdrop="static" centered size="xl">
                    <Modal.Header closeButton>
                        <Modal.Title className='mdl-title'>Add New Rate Master</Modal.Title>
                    </Modal.Header>
                        ...
                        <><Row>
                                        ...
                                        onChange={(e) => {
                                            ...
                                            fetch(getAllProductLines, {
                                                ...
                                                .then((result) => {
                                                    console.log(result);
                                                    setallproductLines(result);
                                                    let plCode = result.filter(obj => obj.parameterTypeId == addRateMaster.productLineCode)
                                                    if (plCode.length == 0) {
                                                        setaddRateMaster((pre) => {
                                                            return {
                                                                ...pre,
                                            ...
                                            const GetAllActivities = `${process.env.REACT_APP_API_URL}Activity/GetActivitymstAsync?activityTypeId=${addRateMaster?.serviceClaimTypeId ? addRateMaster?.serviceClaimTypeId : '0'}&DivisionCode=${divcode ? divcode : '0'}`;
                                            fetch(GetAllActivities, {
                                                headers: {
                                                    "Authorization": `Bearer ${token}`
                                                }
                                                ...
                                                .then((result) => {
                                                    console.log(result);
                                                    setActivities(result);
                                                    // let list = result.filter(obj => obj.activityId == addRateMaster.activityId)
                                                    // if (list.length == 0) {
                                                    //     setaddRateMaster((pre) => {
                                                    //         return {
                                                    //             ...pre,
                            ...
                            <Col md={4}>
                                <Form.Group>
                                    ...
                                    <Form.Select
                                        ...
                                        value={addRateMaster.productLineCode}
                                        onChange={(e) => {
                                            setaddRateMaster((pre) => {
                                                return {
                                                    ...pre,
                            ...
                            <Col md={4}>
                                <Form.Group>
                                    ...
                                    <Form.Select aria-label="Default select example" name='serviceClaimTypeId' value={addRateMaster.serviceClaimTypeId}
                                        onChange={(e) => {
                                            ...
                                            fetch(getAllServices, {
                                                ...
                                                .then((result) => {
                                                    console.log(result);
                                                    setServices(result);
                                                    let list = result.filter(obj => obj.serviceId == addRateMaster.serviceId)
                                                    if (list.length == 0) {
                                                        setaddRateMaster((pre) => {
                                                            return {
                                                                ...pre,
                                            ...
                                            const GetAllActivities = `${process.env.REACT_APP_API_URL}Activity/GetActivitymstAsync?activityTypeId=${e.target.value ? e.target.value : '0'}&DivisionCode=${addRateMaster.productDivCode ? addRateMaster.productDivCode : '0'}`;
                                            fetch(GetAllActivities, {
                                                headers: {
                                                    "Authorization": `Bearer ${token}`
                                                }
                                ...
                                <Col md={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="Default select example" name='activityId' value={addRateMaster.activityId} onChange={handleRateChange}>
                                            <option value='0'>Select</option>
                                            {
                                ...
                                <Col md={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="Default select example" name='serviceId' value={addRateMaster.serviceId} onChange={handleRateChange}>
                                            <option value='0'>Select</option>
                                            {
                                ...
                                <Col md={4} className='mt-3'>
                                    <Form.Group className='mt-4'>
                                        ...
                                        <Form.Check
                                            ...
                                            label="is Minor"
                                            name='isMinor'
                                            checked={addRateMaster?.isMinor}
                                            onChange={(e) => {
                                                setaddRateMaster((prev) => ({
                                                    ...prev,
                    ...
                    <Modal.Footer>
                        ...
                        <Button variant="" className='add-Btn' disabled={rateinputList.some(item => !!item.error)}
                            onClick={(e) => {
                                ...
                                const productDivCode = addRateMaster.productDivCode;
                                ...
                                const productLineCode = addRateMaster.productLineCode;
                                ...
                                const serviceClaimTypeId = addRateMaster.serviceClaimTypeId;
                                ...
                                const activityId = addRateMaster.activityId;
                                ...
                                const serviceId = addRateMaster.serviceId;
                                ...
                                if (!validateAllItems(rateinputList)) {
                                    return
                                }
                                    ...
                                    (async () => {
                                        try {
                                            ...
                                            let n = {
                                                ...addRateMaster,
                                                claimRateDetails: rateinputList,
                                            }
                                            for (let i = 0; i < rateinputList.length; i++) {
