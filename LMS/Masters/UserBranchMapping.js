...
function UserBranchMapping() {
  ...
  return (
    ...
    <Card
            ...
            >
              <p className='pg-label m-0'>User Branch Mapping Master</p>
              <hr />


              <Row className='mb-2'><Col><Button variant='' className='add-Btn' onClick={handleShow}>Add New User Branch Mapping</Button></Col></Row>
...
<Modal.Title className='mdl-title'>Add New User Branch Mapping</Modal.Title>
</Modal.Header>
<Modal.Body>
...
export default UserBranchMapping