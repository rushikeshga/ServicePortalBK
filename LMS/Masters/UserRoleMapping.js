...
function UserRoleMapping() {
  ...
  return (
    ...
    <Card
            ...
            >
              <p className='pg-label m-0'>User Role-Mapping Master</p>
              <hr />


              <Row className='mb-2'><Col><Button variant='' className='add-Btn' onClick={handleShow}>Add New User Role-Mapping</Button></Col></Row>
...
<Modal.Title className='mdl-title'>Add New User Role-Mapping</Modal.Title>
</Modal.Header>
<Modal.Body>
