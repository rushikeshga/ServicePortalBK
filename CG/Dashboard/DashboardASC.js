...
function DashboardASC() {
  ...
  return (
    <>
      {
        LoginRoleName && LoginRoleName == "AS8" || LoginRoleName == "RS9" || LoginRoleName == "AI10" || LoginRoleName == "BD19" || LoginRoleName == "NS20" ?
          <Row className="p-4">
            <Col>
