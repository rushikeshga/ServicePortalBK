...
import TestReport, { handleExportRows, handleExportRowsPdf } from '../TestReport';
...
function FeedbackReport() {
  ...
  const GetdataUrl = `${process.env.REACT_APP_API_URL}TrackServiceTicket/GetAllTrackServiceTicketReport`;
  ...
  const fetchDataPaginate = async () => {
    ...
    const url = new URL(
      ...
      `${process.env.REACT_APP_API_URL}TrackServiceTicket/GetAllTrackServiceTicketReport`,
  ...
  const customHeaders = {
    ...
    rating: 'Rating',
    questionAnswerList: "Question and Answer"
  }
  return (
    <>
        <Card
        ...
        >
          <div className='d-flex justify-content-between'>
            <p className='pg-label m-0'>Feedback Report</p>
            ...
            >
              ...
              <Col md={2}>
                <Form.Group>
                  ...
                  <Form.Select value={filterRating} onChange={e => handleInputChangeRating(e)}>
            ...
            Permissions?.isView ?
              <MaterialReactTable
                ...
                renderDetailPanel={({ row }) => {
                  ...
                  let list = row.original.questionAnswerList
                               // console.log(list1);

                  return (

                    (row.original.questionAnswerList.length != 0) ? (
                      <Box
                      // sx={{
                      //   display: 'grid',
                      //   margin: 'auto',
