...
const ACJobSheet = (props) => {
  ...
  return (
    ...
    <table border={1} cellSpacing={0} cellPadding={0} width={0}>
      <tbody>
        <tr>
          <td width={154} nowrap valign="top">
            <p>
              Machine Number
            </p>
          </td>
          <td width={189} nowrap colSpan={2} valign="top">
          </td>
          <td width={237} nowrap colSpan={2} valign="top">
            <p>
              Serial Number
            </p>
          </td>
        ...
        <tr>
          ...
          <td width={409} nowrap colSpan={4} valign="top">
            <p>
        ...
        <tr>
          ...
          <td width={308} nowrap colSpan={3} valign="top">
        ...
        <tr>
          ...
          <td width={598} nowrap colSpan={6} valign="top">
          </td>
        </tr>
        <tr>
          <td width={154} nowrap valign="top">
        ...
        <tr>
          ...
          <td width={281} nowrap colSpan={3} valign="top">
            <p>
