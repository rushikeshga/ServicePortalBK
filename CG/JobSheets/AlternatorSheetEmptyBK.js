  ...
  <table border={1} cellSpacing={0} cellPadding={0} width={0} style={{border: '1px solid #000', margin: "0",padding: "20px",width:'100%'}}>
    <tbody>
      ...
      <tr>
        ...
        <td width={208} colSpan={3} valign="top" style={{border: '1px solid #000'}}>
        </td>
      </tr>
      <tr>
        <td width={162} nowrap valign="top" style={{border: '1px solid #000'}}>
        ...
        <td width={430} nowrap colSpan={4} valign="top" style={{border: '1px solid #000'}}>
          <p>
            Site address:
          </p>
        </td>
...
export default AlternatorSheetEmpty