...
const NewAssignRequestInt = () => {
    ...
    let serTicNo=localStorage.getItem("SerTicNo")
    ...
    const allStatus = (division) => {
        fetch(`${process.env.REACT_APP_API_URL}Common/GetAllActivityStatus?ServiceTicketId=${serTicId}&ActivityType=${(tab1?.serviceRequestSubStatusId == "30" || submittedDataTab1?.serviceRequestSubStatusId == "30") ? 163 : 164}&DivisionCode=${division}`, {
            ...
            .then((result) => {
                ...
                if ((ticketInfo[0]?.divisionCode != 'M4') || (ticketInfo[0]?.divisionCode != "M3" || ticketInfo[0]?.isAscMultipleTicket=="1")) {
                    console.log(result);
                    setactivityStatus(result)
                }

                if ((!siteVisitExists) && (ticketInfo[0]?.divisionCode == "M4") && ticketInfo[0]?.isAscMultipleTicket=="0") {
                ...
                if ((!siteVisitExists) && (ticketInfo[0]?.productLineCode == "C1") && ticketInfo[0]?.isAscMultipleTicket=="0") {
                ...
                if ((!siteVisitExists) && (ticketInfo[0]?.divisionCode == "M3") && acknowledgementStatus != "Product received at workshop" && ticketInfo[0]?.isAscMultipleTicket=="0") {
                                                        ...
                                                        <Accordion.Header >
                                                            ...
                                                            >
                                                                <p className='m-0'>
                                                                    ...
                                                                    {(acknowledgementStatus == "Customer Contacted" || submittedDataTab1?.serviceRequestSubStatusId=="30") ? "Customer Contacted" : acknowledgementStatus == "Product received at workshop" ? "Product received at workshop" : ""}</p><span>
...
a
                                                                    ...
                                                                    <Row className=' mt-1 align-items-center justofy-content-center  '>
                                                                        <Col md={2} style={{
                                                                            ...
                                                                            <Form.Group className="text-start">
                                                                                <Form.Label>{(acknowledgementStatus == "Customer Contacted" || submittedDataTab1?.serviceRequestSubStatusId=="30") ? "Contact date" : acknowledgementStatus == "Product received at workshop" ? "Product received date" : ""}<span className="req-t">*</span></Form.Label>
                                                    ...
                                                    <Accordion.Item eventKey="2">
                                                        ...
                                                        <Row className="mt-2"> */}
                                                           ...
                                                           {ticketInfo[0]?.isAscMultipleTicket=="1"?"": <Form.Check type='checkbox' label="Were multiple products served?" onChange={(e)=>{
if(e.target.checked){
    ...
    handleCloseMultipleProduct()
                                                            ...
                                                            <GenericModal title="Add Multiple Ticket Information" size="xl" show={showMultipleProdTicket} handleClose={handleCloseMultipleProduct} backdrop="static" IsCentered={true} body={<>
                                                                ...
                                                                {AddedMultipleProductsTable?.length > 0 ? <Row className='text-center'><Col><Button variant='' className='add-Btn' onClick={() => {
                                                                        ...
                                                                        fetch(`${process.env.REACT_APP_API_URL}ProdCustInfo/UpserAscTicketCreate`, {
                                                                            method: "POST",
                                                                            headers: {
                                                                               "Content-Type": "application/json",
                                                                                "Authorization": `Bearer ${token}`
                                                                            },
                                                                            body: JSON.stringify(AddedMultipleProducts)
                                                                        })
                                                                            .then((res) => {
                                                                                let resp = res.text()
                                                                                resp.then((r) => {
                                                                                    ...
                                                                                    if (r.match(digitregex)) {
                                                                                        ...
                                                                                        Swal.fire({
                                                                                            icon:"success",
                                                                                            title:"Multiple tickets added successfully!"
                                                                                        })
                                                                                ...
                                                                                <Row className='mt-1 mb-2 '>
                                                                                    ...
                                                                                    </Col>
                                                                                    {
                                                                                        (
                                                                                            ...
                                                                                            <Col md={4}>
                                                                                                <Form.Group>
                                                                                                    <Form.Label>Rewinding done for</Form.Label>
                                                                                                    <Form.Select
                        ...
                        <Col md={3}>
                            <Form.Group>
                                ...
                                <Form.Control type='text' />
                                                    ...
                                                    {(isASMflow == "false" && ticketInfo[0]?.isAscMultipleTicket=="0") ?
                    ...
                    <GenericModal show={showInCaseSundry} handleClose={handelCloseSundry} size='l' IsCentered='centered' backdrop="static" className='mdl-title' title="Sundry Charges"
                        body={
                            <>
                                ...
                                <Row>
                                    <Col md={12}>
                                        <Form.Group>
                                            <Form.Label>Details Description <span className="req-t">*</span></Form.Label>
                                            <Form.Control as='textarea' rows='2' name='Remarks' value={tab4Deviation?.Remarks} onChange={handleChangetab4Deviation} />
                                ...
                                <Row className='mt-2'>
                                    <Col md={6}>
                                        <Form.Group>
                                            <Form.Label>Amount <span className="req-t">*</span></Form.Label>
                                            <Form.Control type='text' name='ClaimAmount' value={tab4Deviation?.ClaimAmount}
                                                onChange={(e) => {
                                                    settab4Deviation((pre) => {
                                                        return {
                        ...
                        footer={<>
                            <Button variant="" className='cncl-Btn'
                                onClick={() => {
                                    ...
                                    if (tab4Deviation?.AttachmentFile == '') {
                                        Swal.fire({
                                            icon: "error",
                                            title: "Attachment file is required!"
                                        })
