...
// }
  ...
  const fetchAllClaims = async () => {
    ...
    const url = new URL(
      ...
      `${process.env.REACT_APP_API_URL}ASMServiceTicketClaimApproval/GetAllServiceRequestClaimLineItemsView`,
    ...
    <>
        ...
        >
          <div className='d-flex justify-content-between'>
            ...
            <p className='pg-label m-0'>Claim Listing</p>
...
<Col md={2}>
    <Form.Group>
        ...
        {/* type (Warranty / OOW / AMC etc) */}
        <Form.Select value={filteredClaimStatus} onChange={(e) => {
            ...
            <option value='ASM Rejected'>ASM Rejected</option>
            <option value='RSM Approved'>RSM Approved</option>
            <option value='RSM Rejected'>RSM Rejected</option>
            <option value='Accept Rejection'>Accept Rejection</option>
            <option value='ASM UnApproved'>Pending with ASM</option>
            <option value='RSM UnApproved'>Pending with RSM</option>
              ...
              <Table responsive bordered className='mt-3'>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="small-font">Ticket Number</th>
...
export default ClaimApprovalASMView;