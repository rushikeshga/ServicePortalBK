...
const ServiceRequestCancelled = () => {
    ...
    const [listStatus, setlistStatus] = useState("Suspense");
    ...
    const fetchData = async (isReset) => {
        setIsLoading(true)
        // let url = `${process.env.REACT_APP_API_URL}ASCServiceRequest/GetAllASCServiceRequestCancelled${filterByDivision ||
        //     filterByFromDate ||
        //     filterByToDate
        //     ? "?"
        //     : ""
        //     }`;
            ...
            const url = new URL(
                ...
                `${process.env.REACT_APP_API_URL}ASCServiceRequest/GetAllASCServiceRequestCancelled${filterByDivision ||
            filterByFromDate ||
            filterByToDate
            ? "?"
            : ""
            ...
            if(isReset) {
                url.searchParams.set('TicketStatus', "Suspense")
            } 
            else if(filteredTicketType) { url.searchParams.set('TicketStatus', filteredTicketType) }
    ...
    const [filteredTicketType, setfilteredTicketType] = useState("Suspense")
    ...
    const fetchFilterPagination = async (time, reasonEmptyCheck) => {
        ...
        const url = new URL(
            ...
            `${process.env.REACT_APP_API_URL}ASCServiceRequest/GetAllASCServiceRequestCancelled`,
        ...
        if (filteredTicketType) { url.searchParams.set('TicketStatus', `${filteredTicketType}`) }
        ...
        try {
            ...
            console.log(json);
            console.log(json[0]?.totalRows);
            setlistStatus(filteredTicketType)
            if (time == 'lessthan23') {
    ...
    const handleShowAsc = (cellData) => {
        fetchASCList(cellData);
        setShowAsc(true);
    }
    const fetchASCList = (cellData) => {
            ...
            .then((result) => {
                ...
                setDataProduct((pre) => {
                    return {
                        ...
                        emailId: result[0]?.spocEmailId,
                        address: result[0]?.address,
                        mobileNo: result[0]?.spocMobileNo,
                                ...
                                <Row>
                                    <Col lg={3} md={4} sm={6}>
                                        ...
                                        <p className='ticketInfoLabelST'>ASC: <span className='ticketInfoData'>{cellData?.ascName ? cellData?.ascName : "-"}{
                                            (RoleName == "AS8" && listStatus == "Suspense") && <IconButton
                                                className="edit-btn"
                                                onClick={() => {
                                    ...
                                    <Col lg={3} md={4} sm={6}>
                                        ...
                                        {(RoleName == "AS8" && (
                                            ...
                                            {(cellData?.issueStatus == "Worked Upon" || cellData?.issueStatus == "Open" || cellData?.isSpecialApproval) && 
                                                <>
                                                <IconButton
                                                    className="edit-btn"
                                                    onClick={() => {
                                    ...
                                    <Col lg={3} md={4} sm={6}>
                                        ...
                                        <p className='ticketInfoLabelST'>Complaint SubStatus: <span className='ticketInfoData'>{cellData?.subStatusName ? cellData?.subStatusName : "-"}
                                            {/* {
                                                (RoleName == "AS8" 
                                                    // && cellData?.subStatusName == "Cancellation"
                                                ) && <IconButton
                                                    className="edit-btn"
                                                    onClick={() => {
                                                                            ...
                                                                            fetch(
                                                                                ...
                                                                                .then((result) => {
                                                                                    ...
                                                                                    setCancellationData({
                                                                                        ...
                                                                                        approvalStatus: 0,
                                                                                        ticketAssignedASCCode: 0,
                                                                                        assignedASC:cellData?.ascName,
                                                                                        isTicketCustomer: cellData?.isTicketCustomer
                                                                                    });
                                                                                });
        ...
        <>
            ...
            >
                <div className='d-flex justify-content-between'>
                    ...
                    <p className='pg-label m-0'>Suspense/Cancellation Requests</p>
                    ...
                    <Row >
                        ...
                        <Col md={2}>
                            <Form.Group>
                                ...
                                <Form.Select value={filteredTicketType} onChange={(e) => {
                                    setfilteredTicketType(e.target.value)
                                }}>
                                    {/* <option value=''>Select</option> */}
                        ...
                        {/* <Col md={2}>
                            <Form.Group>
                                ...
                                <Form.Select value={filteredIssueStatus} onChange={(e) => {
                                    ...
                                    <option value='Worked Upon'>Worked Upon</option>
                                ...
                                <div className='gap-2 d-flex mt-4'>
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            setfilteredDivision("")
                                            setfilteredProductLine("")
                                            setfilteredTicketType("Suspense")
                            ...
                            <Row>
                                ...
                                <Col lg={12} md={12} sm={12}>
                                    <Card className='p-2' style={{ boxShadow: "0px 0px 2px 2px rgba(176,195,212,1)" }}>
                                            ...
                                            <Col lg={12} md={12} sm={12}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Select
                                                        ...
                                                        <option value={0}>Select</option>
                                                        {/* { cancellationData?.isTicketCustomer == "ASM001"  && */}
                                                           <>
                                        ...
                                        <Row>
{cancellationData?.approvalStatus == 3 &&
                    ...
                    footer={<>
                        ...
                        <Button variant="" className='add-Btn'
                            onClick={(e) => {
                                ...
                                if (cancellationData.approvalStatus == 3) {
                                    if (cancellationData.ticketAssignedASCCode == 0) {
                                        Swal.fire({
                                            icon: "error",
                                            title: "Please Select Agent",
                                        });
                                    ...
                                    let inputParam = {
                                        ...
                                        ticketAssignedASCCode: cancellationData?.ticketAssignedASCCode,
                                        remark: cancellationData?.approvedComments
                                    }
                                       ...
                                       <Row>
                                            ...
                                            <Col lg={6} md={12} sm={12}>
                                                <p className='mt-4 Bold' 
                                                    style={{
                                                        color: "rgb(0, 91, 171)",
                                                        fontWeight:"600"}}>Status: {approvalData?.specialApprovalStatus} </p>
                                            </Col>
                                        </Row>
                    }
                                        <Row>
                            ...
                            <Row>
                                ...
                                <Col md={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="Default select example" name='divisionName' value={dataProduct?.divCode} onChange={(e) => {
                                ...
                                <Col md={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="Default select example" name='productLineName' value={dataProduct?.productLineCode} onChange={(e) => {
                                            const selectedOption = e.target.options[e.target.selectedIndex];
                    ...
                    footer={<>
                        ...
                        <Button variant="" disabled={emailError2 || mobileError2 || pinError1} className='add-Btn'
                            onClick={() => {
                                ...
                                if (dataProduct?.divCode == '' || dataProduct?.productLineCode == '') {
...
export default ServiceRequestCancelled